 ...
 * @author Ashish
 */
public class AccountsViewRequestJPanel extends javax.swing.JPanel {

    JPanel userProcessContainer;
    LabRequestEquipment request;
    public AccountsViewRequestJPanel(JPanel userProcessContainer, LabRequestEquipment request) {
        initComponents();
    ...
    public void populateOrderTable()
    {
        ...
        for (OrderItem oi : request.getOrder().getOrderItemList())
        {
            ...
            row[2] = request.getStatus()==Constants.Status.Forwarded ? "Pending":request.getStatus();
