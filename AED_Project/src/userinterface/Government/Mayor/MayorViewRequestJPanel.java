 ...
 * @author Ashish
 */
public class MayorViewRequestJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    LabRequestEquipment request;
    public MayorViewRequestJPanel(JPanel userProcessContainer, LabRequestEquipment request) {
        initComponents();
    ...
    public void populateOrderTable()
    {
        ...
        for (OrderItem oi : request.getOrder().getOrderItemList())
        {
            ...
            row[2] = request.getStatus()==Constants.Status.Forwarded_AM ? "Pending":request.getStatus();
